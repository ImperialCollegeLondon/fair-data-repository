...
SYMPLECTIC_RECORD_EXPORT_ENABLED = os.getenv("SYMPLECTIC_RECORD_EXPORT_ENABLED", False)

SYMPLECTIC_PUBLICATION_LINKS_ENABLED = os.getenv(
    "SYMPLECTIC_PUBLICATION_LINKS_ENABLED", False
)
SYMPLECTIC_FUNDING_LINKS_ENABLED = os.getenv("SYMPLECTIC_FUNDING_LINKS_ENABLED", False)
ENABLE_SYMPLECTIC_SEARCH = False
