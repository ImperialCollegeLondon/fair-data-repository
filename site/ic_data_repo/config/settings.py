...
SYMPLECTIC_RECORD_EXPORT_ENABLED = os.getenv("SYMPLECTIC_RECORD_EXPORT_ENABLED")

SYMPLECTIC_PUBLICATION_LINKS_ENABLED = os.getenv("SYMPLECTIC_PUBLICATION_LINKS_ENABLED")
SYMPLECTIC_FUNDING_LINKS_ENABLED = os.getenv("SYMPLECTIC_FUNDING_LINKS_ENABLED")
